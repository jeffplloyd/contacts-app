...
function App() {
  ...
  return (
    <main>
      <div className="sidebar" data-show={showSidebar}>
        <Panel>
      ...
      <div className="content" data-show={!showSidebar && pathname === "/"}>
      ...
      <div className="contact-details" data-show={pathname.includes("contact")}>
        <AppRouter />
      </div>
    </main>
  )
