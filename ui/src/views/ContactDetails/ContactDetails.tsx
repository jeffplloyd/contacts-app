          ...
          <Card>
            <div className="contact-details__main-info">
              ...
              <div className="contact-details__name">
                <span>{contactData?.fname} {contactData?.lname}</span>
            ...
            <div className="contact-details__actions">
              ...
              <Button 
                ...
                icon={
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.75 0.75V2H10.25V0.75C10.25 0.34375 10.5625 0 11 0C11.4062 0 11.75 0.34375 11.75 0.75V2H13C14.0938 2 15 2.90625 15 4V4.5V6V14C15 15.125 14.0938 16 13 16H3C1.875 16 1 15.125 1 14V6V4.5V4C1 2.90625 1.875 2 3 2H4.25V0.75C4.25 0.34375 4.5625 0 5 0C5.40625 0 5.75 0.34375 5.75 0.75ZM2.5 6V14C2.5 14.2812 2.71875 14.5 3 14.5H13C13.25 14.5 13.5 14.2812 13.5 14V6H2.5Z" fill="currentColor"/>
                  </svg>
                }
                variant="secondary"
              />
