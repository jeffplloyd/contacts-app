      ...
      >
        <div>
          <div className="contact__avatar">
            <Avatar initals={`${contact.fname.charAt(0)}${contact.lname.charAt(0)}`} />
          </div>
        ...
        <span className="contact__action">
          {isFavorite ? (
            <svg
              ...
              className="contact__icon contact__icon--is-favorite"
              viewBox="0 0 576 512"
            >
              <path
                fill="currentColor"
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="contact__icon contact__icon--not-favorite"
              viewBox="0 0 576 512"
            >
              <path
                fill="currentColor"
