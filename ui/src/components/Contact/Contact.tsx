...
const Contact = ({ 
  ...
  const findParentElement = (element: HTMLElement) => {
    return element.closest(".contact__action");
  }
      ...
      >
        <div>
          <div className="contact__avatar">
            <Avatar
              initals={`${contact.fname.charAt(0)}${contact.lname.charAt(0)}`}
            />
          </div>
          <div className="contact__info">
            {contact.fname} {contact.lname}
            <div className="contact__info__role">
              <Badge>{contact.role || "Other"}</Badge>
            </div>
          </div>
        </div>
        ...
        <span className="contact__action">
          { isFavorite ? (
            <svg xmlns="http://www.w3.org/2000/svg" className="contact__icon contact__icon--is-favorite" viewBox="0 0 576 512">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="contact__icon contact__icon--not-favorite" viewBox="0 0 576 512">
